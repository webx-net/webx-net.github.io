				...
				<div className="flex lg:flex-row flex-col items-center -mx-4 justify-center lg:text-left text-center">
					<div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
						<div className="flex flex-col">
							<h2 className="mb-2  text-4xl 2xl:text-5xl font-bold tracking-normal text-primaryText">
								Trusted by companies
							</h2>
							<h2 className=" text-4xl 2xl:text-5xl font-bold tracking-normal text-secondaryColor">
								all over the world
							</h2>
							<p className="mt-6 text-secondaryText leading-loose">
								Amazing developers use Web X to build incredible web applications for millions of companies.
							</p>
						</div>
					</div>
